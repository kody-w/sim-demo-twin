...
> Bundled at planting time on 2026-05-09T13:57:37Z. The authoritative source is the parent repo; this is the self-contained subset every planting needs.
...
For this neighborhood: `id` = `@kody-w/sim-demo-twin`.
