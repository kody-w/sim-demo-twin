# specs/ — bundled contracts for Sim Demo Twin
...
This directory was bundled on **2026-05-09T13:57:37Z** from `kody-w/RAPP @ fb784f9 (post-Bond-Pulse)`. The contracts here are FROZEN at planting time — they do not change unless an operator runs a `specs refresh` action.
...
- **Lifted at:** 2026-05-09T13:57:37Z
...
```bash
# (future) brainstem run specs-refresh --neighborhood kody-w/sim-demo-twin
```
